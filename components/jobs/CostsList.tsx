        ...
        <div className="space-y-2">
          {costs.map(cost => (
            <div
              ...
              style={{ background: "hsl(217 33% 10%)" }}
            >
              <div>
                <p className="text-sm" style={{ color: "hsl(210 40% 98%)" }}>{cost.description}</p>
                <p className="text-xs" style={{ color: "hsl(215 20% 45%)" }}>{cost.cost_date}</p>
              </div>
