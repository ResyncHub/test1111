            ...
            <div className="grid grid-cols-1 gap-2">
              {SUGGESTIONS.map(s => (
                <button
                  key={s}
                  onClick={() => send(s)}
                  className="text-left text-xs rounded-xl px-3 py-2.5 border transition-colors"
                  style={{
          ...
          <div key={i} className={`flex ${m.role === "user" ? "justify-end" : "justify-start"}`}>
            {m.role === "assistant" && (
              <div
                ...
                style={{ background: "hsla(262,80%,60%,0.15)" }}
              >
        ...
        {loading && (
          <div className="flex justify-start">
            ...
            <div
              ...
              style={{ background: "hsl(222 47% 9%)", border: "1px solid hsl(217 33% 15%)", borderBottomLeftRadius: "4px" }}
            >
