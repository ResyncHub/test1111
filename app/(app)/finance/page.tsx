    ...
    <div className="py-4 space-y-4">
      ...
      {loading ? (
        ...
        <div className="rounded-xl border p-4" style={{ background: "hsl(222 47% 7%)", borderColor: "hsl(217 33% 15%)" }}>
          <p className="text-[10px] font-semibold uppercase tracking-widest mb-3" style={{ color: "hsl(215 20% 55%)" }}>
            PRZYCHODY VS KOSZTY
          </p>
      ...
      <div className="rounded-xl border overflow-hidden" style={{ background: "hsl(222 47% 7%)", borderColor: "hsl(217 33% 15%)" }}>
        <div
          ...
          style={{ background: "hsl(217 33% 10%)", color: "hsl(215 20% 55%)" }}
        >
          <span>Miesiąc</span>
        ...
        {data.map(d => (
          ...
          >
            ...
            <span className="text-right" style={{ color: "hsl(142 76% 46%)" }}>
              {d.total_revenue > 0 ? formatPLN(Number(d.total_revenue)) : "—"}
            </span>
            <span className="text-right" style={{ color: "hsl(0 72% 61%)" }}>
              {d.total_costs > 0 ? formatPLN(Number(d.total_costs)) : "—"}
            </span>
            <span
              className="text-right font-semibold"
              style={{ color: Number(d.profit) >= 0 ? "hsl(217 91% 60%)" : "hsl(0 72% 61%)" }}
            >
